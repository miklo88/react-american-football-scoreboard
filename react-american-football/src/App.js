...
//   const [reset, updateScore] = useState(0);
  ...
  const [scoreLions, updateLions] = useState(32);
  const [scoreTigers, updateTigers] = useState(32);
//   most common 
    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown" onClick={() => updateLions(scoreLions + 7)}>Home Touchdown</button>
          <button className="homeButtons__fieldGoal" onClick={() => updateLions(scoreLions + 3)}>Home Field Goal</button>
          <button onClick={() => updateLions(32)}>Reset</button>
        ...
        <div className="awayButtons">
          ...
          <button className="awayButtons__touchdown" onClick={() => updateTigers(scoreTigers + 7)}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={() => updateTigers(scoreTigers + 3)}>Away Field Goal</button>
          <button onClick={() => updateTigers(32)}>Reset</button>          
          <button onClick={() => setInitialValue(0)}>Reset/zero</button>
        </div>
      </section>
    </div>
